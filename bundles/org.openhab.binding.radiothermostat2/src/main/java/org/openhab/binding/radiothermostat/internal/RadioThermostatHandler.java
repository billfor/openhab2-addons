...
public class RadioThermostatHandler extends BaseThingHandler {
    ...
    private @Nullable RadioThermostatTstat tstat = new RadioThermostatTstat();
    private @Nullable RadioThermostatTstatDatalog datalog = new RadioThermostatTstatDatalog();
    ...
    private void updateData() {
        ...
        try {
            ...
            logger.info("Unable to fetch data from {}", e, baseURL);
            goOffline(ThingStatusDetail.COMMUNICATION_ERROR, e.getMessage());
        }
    }
    ...
    private void updateHistory() {
        ...
        try {
            ...
            updateState(CHANNEL_HEAT_RUNTIME_YESTERDAY, new QuantityType<>(heat_usage, Units.MINUTE));
            updateState(CHANNEL_COOL_RUNTIME_YESTERDAY, new QuantityType<>(cool_usage, Units.MINUTE));
            ...
            updateState(CHANNEL_HEAT_RUNTIME_TODAY, new QuantityType<>(heat_usage, Units.MINUTE));
            updateState(CHANNEL_COOL_RUNTIME_TODAY, new QuantityType<>(cool_usage, Units.MINUTE));
    ...
    protected void goOffline(ThingStatusDetail detail, @Nullable String reason) {
